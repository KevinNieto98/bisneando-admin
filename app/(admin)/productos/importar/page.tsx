...
export default function ImportarProductosPage() {
  /** Tabs (usamos el componente Tabs) */
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-4">
      ...
      {/* Tabs header usando el componente */}
      <div className="mt-6">
        <Tabs value={activeTab} onValueChange={(v) => setActiveTab(v as "carga" | "historial")} className="w-full">
          <TabsList className="inline-flex rounded-xl bg-neutral-50 p-1">
            <TabsTrigger value="carga">Carga de Productos</TabsTrigger>
            <TabsTrigger value="historial">Histórico de Carga</TabsTrigger>
          </TabsList>
