...
export const Title = ({
  ...
  // 🎨 Fondo amarillo/amber súper suave por defecto (ajústalo con bgClassName si deseas)
  const softYellowBg = bgClassName ?? "bg-amber-100";

  // 🎨 Botón amarillo con buen contraste y estados de foco/hover/active
  const buttonClasses =
  ...
  return (
    ...
    >
      <div className="flex items-start gap-3 w-full">
        {/* Contenedor de ícono con marquito circular en amarillos */}
